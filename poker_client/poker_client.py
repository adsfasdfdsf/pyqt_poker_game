...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.opp_move_label.setGeometry(QtCore.QRect(471, 10, 541, 31))
        self.opp_move_label.setObjectName("opp_move_label")

        self.leave_button = QtWidgets.QPushButton(parent=self.centralwidget)
        self.leave_button.move(670, 10)
